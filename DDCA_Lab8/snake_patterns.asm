...
.data
pattern: .word 0x00004000, 0x00200000,0x00004000,0x00000080,0x00000001,0x00000002,0x00000004,0x00000008,0x00000400,0x00020000,0x01000000,0x02000000,0x04000000
...
wait:
   ...
   lw $t7, 0x7ff4($0)
   addi $t7, $t7, 1
   add  $t2, $t2, $t7     # increment counter
   j wait
